...
public class BWStatusEffects {
	...
	public static final StatusEffect CORROSION = create("corrosion", new EmptyStatusEffect(StatusEffectCategory.HARMFUL, 0x6fc536).addAttributeModifier(EntityAttributes.GENERIC_ARMOR, Identifier.of("5b5df91d-001a-464f-a773-ab4ccd62e09f"), -3, EntityAttributeModifier.Operation.ADD_VALUE));
	...
	public static final StatusEffect HARDENING = create("hardening", new EmptyStatusEffect(StatusEffectCategory.BENEFICIAL, 0x3fa442).addAttributeModifier(EntityAttributes.GENERIC_ARMOR, Identifier.of("7f7f1ce3-6383-49a8-a9f1-af0f5c7ab38f"), 3, EntityAttributeModifier.Operation.ADD_VALUE));
	...
	public static final StatusEffect PACT = create("pact", new EmptyStatusEffect(StatusEffectCategory.HARMFUL, 0x7d0000).addAttributeModifier(EntityAttributes.GENERIC_MAX_HEALTH, Identifier.of("be0cf4d3-6e4b-43e6-9831-9e7d14aa14a7"), -1, EntityAttributeModifier.Operation.ADD_VALUE));
